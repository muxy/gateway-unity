...
namespace MuxyGateway.Imports
{
    ...
    public delegate void GatewayDebugMessageDelegate(VoidPtr UserData, [MarshalAs(UnmanagedType.LPStr)] String Message);
    ...
    public class Imported
    {
        ...
        public static extern Schema.GatewaySDK MGW_MakeSDK([MarshalAs(UnmanagedType.LPStr)] String GameID);
        ...
        public static extern StringPtr MGW_SDK_GetProjectionSandboxURL(Schema.GatewaySDK SDK, [MarshalAs(UnmanagedType.LPStr)] String Projection, int Major, int Minor, int Patch);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_GetProjectionProductionURL")]
        public static extern StringPtr MGW_SDK_GetProjectionProductionURL(Schema.GatewaySDK SDK, [MarshalAs(UnmanagedType.LPStr)] String Projection, int Major, int Minor, int Patch);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_AuthenticateWithPIN")]
        public static extern RequestId MGW_SDK_AuthenticateWithPIN(Schema.GatewaySDK SDK, [MarshalAs(UnmanagedType.LPStr)] String PIN, GatewayAuthenticateResponseDelegate Delegate, VoidPtr User);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_AuthenticateWithRefreshToken")]
        public static extern RequestId MGW_SDK_AuthenticateWithRefreshToken(Schema.GatewaySDK SDK, [MarshalAs(UnmanagedType.LPStr)] String Refresh, GatewayAuthenticateResponseDelegate Delegate, VoidPtr User);
        ...
        public static extern void MGW_SDK_EnableAction(Schema.GatewaySDK Gateway, [MarshalAs(UnmanagedType.LPStr)] String ID);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_DisableAction")]
        public static extern void MGW_SDK_DisableAction(Schema.GatewaySDK Gateway, [MarshalAs(UnmanagedType.LPStr)] String ID);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_SetActionMaximumCount")]
        public static extern void MGW_SDK_SetActionMaximumCount(Schema.GatewaySDK Gateway, [MarshalAs(UnmanagedType.LPStr)] String ID, Int32 count);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_SetActionCount")]
        public static extern void MGW_SDK_SetActionCount(Schema.GatewaySDK Gateway, [MarshalAs(UnmanagedType.LPStr)] String ID, Int32 count);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_IncrementActionCount")]
        public static extern void MGW_SDK_IncrementActionCount(Schema.GatewaySDK Gateway, [MarshalAs(UnmanagedType.LPStr)] String ID, Int32 count);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_DecrementActionCount")]
        public static extern void MGW_SDK_DecrementActionCount(Schema.GatewaySDK Gateway, [MarshalAs(UnmanagedType.LPStr)] String ID, Int32 count);
        ...
        public static extern void MGW_SDK_AcceptAction(Schema.GatewaySDK Gateway, MGW_ActionUsed Coins, [MarshalAs(UnmanagedType.LPStr)] String Reason);

        [DllImport("cgamelink.dll", EntryPoint = "MGW_SDK_RefundAction")]
        public static extern void MGW_SDK_RefundAction(Schema.GatewaySDK Gateway, MGW_ActionUsed Coins, [MarshalAs(UnmanagedType.LPStr)] String Reason);
        #endregion
    }
}